...
export class Nodo3 {
  ...
  readonly modalOpinologoContent = `
    <h3 style="color:#e91e8c;margin-top:0">Periodista, Comunicador y Opinólogo</h3>
    <p style="line-height:1.6">Eduardo Santa Cruz señala que el opinólogo es "la encarnación del sentido común": su legitimidad televisiva no proviene de formación especializada, sino de su capacidad de representar la opinión del ciudadano promedio. Pamela Jiles agrega que su irrupción permitió integrar voces más cercanas a la audiencia.</p>
    <p style="line-height:1.6">Sin embargo, Carolina Martínez advierte que <strong>manejar los códigos de la televisión no garantiza preparación periodística ni herramientas éticas</strong>. La distinción entre periodista (formación y colegiatura), comunicador (manejo de medios) y opinólogo (legitimidad televisiva por cercanía) es fundamental, porque cada figura implica un nivel diferente de responsabilidad editorial y ética ante lo que se dice en pantalla.</p>
  `;
